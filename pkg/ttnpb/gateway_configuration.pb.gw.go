...
var (
	filter_GatewayConfigurationService_GetGatewayConfiguration_0 = &utilities.DoubleArray{Encoding: map[string]int{"gateway_ids": 0, "gateway_id": 1, "format": 2}, Base: []int{1, 1, 1, 2, 0, 0}, Check: []int{0, 1, 2, 1, 3, 4}}
)
...
var (
	pattern_GatewayConfigurationService_GetGatewayConfiguration_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"gcs", "gateways", "gateway_ids.gateway_id", "configuration", "format"}, "", runtime.AssumeColonVerbOpt(true)))
)
