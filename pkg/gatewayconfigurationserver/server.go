...
func New(c *component.Component, conf *Config) (*Server, error) {
	...
	hooks.RegisterUnaryHook("/ttn.lorawan.v3.GCs", rpclog.NamespaceHook, rpclog.UnaryNamespaceHook("gatewayserver"))
	hooks.RegisterUnaryHook("/ttn.lorawan.v3.GCs", cluster.HookName, c.ClusterAuthUnaryHook())
