...
var errInvalidConfigurationFormat = errors.DefineInvalidArgument("invalid_configuration_format", "configuration format is not supported")
...
func (s *Server) GetGatewayConfiguration(ctx context.Context, req *ttnpb.GetGatewayConfigurationRequest) (*ttnpb.GetGatewayConfigurationResponse, error) {
	...
	default:
		return nil, errInvalidConfigurationFormat.New()
	}
